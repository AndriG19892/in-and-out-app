...
const TransactionsPage = () => {
    ...
    const styles = {
        ...
        dateInputHidden: {
            ...
            width: '100%',
            height: '100%',
            opacity: 0, // Lo rende invisibile
            cursor: 'pointer',
            zIndex: 2, // Sta sopra al bottone per intercettare il click
        },
        filterScroll: {
            display: 'flex',
            gap: '10px',
        ...
        <div style={ styles.container }>
            ...
            { filterDate ? new Date ( filterDate ).toLocaleDateString ( 'it-IT' ) : "Data" }
                ...
                <div style={ styles.filterScroll } className="hide-scrollbar">
                    { categories.map ( cat => (
                        <div key={ cat } style={ styles.filterBadge ( filterCategory === cat ) }
